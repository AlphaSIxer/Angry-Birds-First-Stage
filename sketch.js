...
function draw(){
    ...
    // detectollision(shoot,a1)
    // detectollision(shoot,a2)
    // detectollision(shoot,a3)
    // detectollision(shoot,a4)
    // detectollision(shoot,a5)
    // detectollision(shoot,a6)
    // detectollision(shoot,a7)
    // detectollision(shoot,a8)
    // detectollision(shoot,a9)
